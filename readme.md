...
Pour installer une ia générative en locale : (on aura choisi la version gemma4:e2b)
Il faut d'abord installer ollama, pour linux : 
> curl -fsSL https://ollama.com/install.sh | sh
Sinon regarder la documentation de ollama
ensuite faire : 
